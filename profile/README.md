...
[![Trans-Pride](https://pride-badges.pony.workers.dev/static/v1?label=%3E%20developed-with-pride&stripeWidth=6&stripeColors=E40303,FF8C00,FFED00,008026,24408E,732982)](#)  
...
Originally the, **[puppy-console](https://github.com/puppy-tools/puppy-console)** organization — a playful nod to the **[kitty](https://github.com/kovidgoyal/kitty)** terminal, but later renamed to **[puppy-tools](https://github.com/puppy-tools/)**.  

> [!NOTE]
> All of the tools created by this organization are (F)OSS, and plan to be for the foreseeable future.
